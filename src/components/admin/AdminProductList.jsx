...
export const AdminProductList = ({ onOpenAddModal, onEditProduct }) => {
  ...
  return (
    <div className="space-y-5">
      {/* Controls Bar */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-white dark:bg-[#11182A] p-4 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm">
      ...
      {/* Table Container */}
      <div className="overflow-x-auto rounded-2xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0E1527] shadow-sm dark:shadow-xl">
